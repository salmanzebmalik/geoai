...
CACHE_DIR = "ml-service/app/models/local_langsam"
...
gdino_hf_dir = os.path.join(CACHE_DIR, "groundingdino_hf_model")
# -base or -tiny
...
ckpt_path = os.path.join(CACHE_DIR, f"{SAM2_VARIANT}.pt")
...
snapshot_download(
    ...
    local_dir=os.path.join(CACHE_DIR, "bert-base-uncased"),
    local_dir_use_symlinks=False,
    resume_download=True,
)
print("BERT processor files downloaded and saved to:", os.path.join(CACHE_DIR, "bert-base-uncased"))


print(f"All files saved under {CACHE_DIR}")
